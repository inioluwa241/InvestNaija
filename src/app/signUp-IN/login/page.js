  ...
  return (
    <div className="login-page min-h-screen flex items-center justify-center bg-white">
      <div
        ...
        className=" flex flex-col  justify-center gap-12 bg-white p-12 rounded shadow-md w-full min-h-screen"
      >
        <div className="flex flex-col items-center gap-3 mb-6">
          {/* Logo and Title */}
          <div className="flex flex-col items-center mb-6">
            <img src="/images/logo.png" alt="InvestNaija Logo" />
            <p className="text-2xl font-semibold text-[var(--primary)]">
              InvestNaija
            </p>
          </div>
          <p className=" text-4xl font-extrabold text-gray-800 mb-6 text-center">
            Welcome to InvestNaija
          </p>
          <p className="text-var(--sm) text-gray-500 mb-4 text-center">
            LEARN. INVEST. GROW.
          </p>
        </div>
        ...
        <div className="flex flex-col items-center justify-center gap-3 space-y-4 my-6">
          <button
            style={{ padding: "2rem" }}
            className="flex items-center justify-center gap-4 w-128 h-12 px-4 py-6 bg-white text-gray-800 p-2 border border-gray-300 rounded-4xl hover:bg-[var(--primary)] hover:text-white transition duration-200 cursor-pointer"
          >
            <svg
        ...
        <div className="flex flex-col items-center justify center gap-4 space-y-4">
          ...
          />
          <button
            onClick={handleSuccessEvent}
            style={{ marginTop: "3rem", padding: "2rem" }}
            className=" flex items-center justify-center gap-4 w-128 h-12 px-4 py-6 bg-[var(--primary)] text-white p-2 rounded-4xl hover:bg-white hover:py-12 hover:text-emerald-200 hover:border-2 hover:border-emerald-200 hover:text-xl hover:font-bold cursor-pointer transition duration-200"
          >
        ...
        <div className="flex flex-col items-center justify-center gap-2 mt-6 mb-6">
          <p className="flex items-center gap-2 text-sm text-gray-500 mb-4 text-center">
            ...
            <a
              href="/signUp-IN/signUp"
              className="mx-2 text-[var(--primary)] font-bold hover:underline"
            >
              Sign Up
            </a>
          </p>
