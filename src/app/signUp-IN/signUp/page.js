    ...
    return (
        <div  className="flex flex-col items-center justify-center bg-white min-h-screen">
            <div style={{marginTop:'2rem',paddingBottom:'2rem'}} className="flex flex-col justify-center gap-12 bg-white shadow-md w-full h-full ">
               <div className="flex flex-col items-center gap-5 mb-6 mt-24">
                 {/* Logo and Title */}  
                <div className="flex flex-col items-center gap-3 mb-6">
                    <img
                        ...
                        className="w-25 h-25"
                    /> 
                    <p className='text-3xl font-semibold text-[var(--primary)]'>InvestNaija</p>
                </div>
                <p className="text-4xl font-extrabold text-gray-800 mb-6 text-center">Welcome to InvestNaija</p>
                <p className="text-sm text-gray-500 mb-4 text-center">LEARN. INVEST. GROW.</p>
               </div>
               <h3 className="text-2xl font-light text-gray-700 text-center">Sign up to continue</h3>
               {/*Social Media Buttons*/}
                <div className="flex flex-col items-center justify-center gap-3 space-y-4 my-6">
                     <button style={{padding:'2rem'}} className="flex items-center justify-center gap-4 w-128 h-12 p-24-6 bg-white text-gray-800 p-2 border border-gray-400 rounded-4xl hover:bg-[var(--primary)] hover:text-white transition duration-200 cursor-pointer">
                    ...
                    <button style={{padding:'2rem'}} className="flex items-center justify-center gap-4 w-128 h-12 px-4 py-6 bg-white text-gray-800 p-2 border border-gray-400 rounded-4xl hover:bg-[var(--primary)] hover:text-white transition duration-200 cursor-pointer">
                ...
                <div className="flex flex-col items-center justify-center gap-4 space-y-4">
                    ...
                    />
                      <button style={{ marginTop:'3rem', padding:'2rem'}} className=" flex items-center justify-center gap-4 w-128 h-12 px-4 py-6 mb-24 bg-[var(--primary)] text-white p-2 rounded-4xl hover:bg-white hover:py-12 hover:text-emerald-200 hover:border-2 hover:border-emerald-200 hover:text-xl hover:font-bold cursor-pointer transition duration-200">
                ...
                <div className='flex flex-col items-center justify-center gap-2 mt-6'>
                    <p className=' flex items-center gap-2 text-sm text-gray-500 mb-4 text-center'>
                        ...
                        <a href="/signUp-IN/login" className="mx-2 text-[var(--primary)] font-bold hover:underline">
                            Log In
                        </a>
                    </p>
                </div>
