// import Button from "../../DashBoard/Generic-Component/Button";
    ...
    >
      <div className="container mx-auto p-36 flex justify-between items-center">
        <div className="flex gap-2 justify-center items-center">
          ...
          />
          <p className="text-3xl font-bold text-[var(--primary)] mr-4">
            InvestNaija
          </p>
        </div>
        <div className="hidden md:flex gap-16 items-center space-x-8">
          ...
          <div className="hidden md:flex gap-4">
            <button
              style={{ paddingBlock: ".75rem", paddingInline: "2rem" }}
              className="bg-gray-200 text-gray-800 rounded-lg hover:bg-[var(--primary)] hover:text-white hover:font-semibold transition-colors !rounded-button cursor-pointer whitespace-nowrap"
            >
              <Link href="../signUp-IN/login">Login</Link>
            </button>
            <button
              style={{ paddingBlock: ".75rem", paddingInline: "2rem" }}
              className="bg-[var(--primary)] text-white rounded-lg hover:bg-gray-100 hover:text-[var(--primary)] hover:font-semibold transition-colors !rounded-button cursor-pointer whitespace-nowrap"
            >
