        ...
        <div className="flex flex-col gap-5 md:flex-row items-center">
          <div className="flex flex-col items-start gap-3.5 w-full md:w-1/2 md:pr-12 mb-12 md:mb-0">
            ...
            <div
              ...
              className="flex flex-col gap-3 sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4"
            >
              <button
                style={{ padding: "1rem 2rem" }}
                className="bg-[var(--primary)] text-white px-8 py-3 rounded-lg hover:bg-emerald-600 transition-colors shadow-lg !rounded-button cursor-pointer whitespace-nowrap"
              >
                <Link href="../signUp-IN/signUp">Get Started for Free</Link>
              </button>
              <button
                style={{ padding: "1rem 2rem" }}
